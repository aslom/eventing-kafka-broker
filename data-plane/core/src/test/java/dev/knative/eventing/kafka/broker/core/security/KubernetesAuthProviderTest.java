...
public class KubernetesAuthProviderTest {
  ...
  public void getCredentialsFromSecretSaslSsl(final Vertx vertx, final VertxTestContext context) {
    ...
    final var contractAuthSecretReference = DataPlaneContract.Reference
      .newBuilder()
      .setNamespace(secret.getMetadata().getNamespace())
      .setName(secret.getMetadata().getName())
      .build();

    final var resource = DataPlaneContract.Resource
      .newBuilder()
  ...
  public void getCredentialsFromMultipleSecretsPlaintext(final Vertx vertx, final VertxTestContext context) {
    ...
    final var contractMultiSecretBuilder = DataPlaneContract.MultiSecretReference
      .newBuilder()
      .setProtocol(DataPlaneContract.Protocol.PLAINTEXT);
    final var secretData = getPlaintextSecretData();
  ...
  public void getCredentialsFromMultipleSecretsSsl(final Vertx vertx, final VertxTestContext context) {
    final var contractMultiSecretBuilder = DataPlaneContract.MultiSecretReference
      .newBuilder()
      .setProtocol(DataPlaneContract.Protocol.SSL);
  ...
  public void shouldFailOnSecretNotFound(final Vertx vertx, final VertxTestContext context) {
    final var secretReference = DataPlaneContract.Reference
      .newBuilder()
  ...
  public void shouldFailOnMultiSecretNotFound(final Vertx vertx, final VertxTestContext context) {
    final var contractMultiSecretBuilder = DataPlaneContract.MultiSecretReference
      .newBuilder()
      .setProtocol(DataPlaneContract.Protocol.SASL_SSL)
      .addReferences(DataPlaneContract.SecretReference.newBuilder().setReference(DataPlaneContract.Reference.newBuilder()
  ...
  public void shouldFailOnInvalidMultiSecret(final Vertx vertx, final VertxTestContext context) {
    ...
    final var secretReference = DataPlaneContract.MultiSecretReference
      .newBuilder()
      .setProtocol(DataPlaneContract.Protocol.SASL_SSL);
  ...
  private Secret createSecret(final String name,
                              final Map<String, String> secretData,
                              final Map<String, String> keySecretDataKeyMapping) {
    final var data = keySecretDataKeyMapping
      .entrySet()
      .stream()
  ...
  private Secret createSecret(final String name, final Map<String, String> data) {
    final Secret userCrtSecret = getSecret(
      data,
      name
    );
  ...
  private static void addUsernamePasswordReference(Secret userSecret, DataPlaneContract.MultiSecretReference.Builder multiSecret) {
  ...
  private static void addSaslMechanismReference(Secret saslMechanismSecret, DataPlaneContract.MultiSecretReference.Builder multiSecret) {
    multiSecret
  ...
  private static void addCACertReference(final Secret caCert,
                                         final DataPlaneContract.MultiSecretReference.Builder multiSecret) {
    multiSecret
      .addReferences(DataPlaneContract.SecretReference.newBuilder()
        .setReference(DataPlaneContract.Reference.newBuilder()
  ...
  private void addUserCertReference(Secret userCrtSecret, DataPlaneContract.MultiSecretReference.Builder multiSecret) {
    multiSecret
      .addReferences(DataPlaneContract.SecretReference.newBuilder()
        .setReference(DataPlaneContract.Reference.newBuilder()
  ...
  private void caCrtSecret(Map<String, String> secretData, DataPlaneContract.MultiSecretReference.Builder multiSecret) {
    final Secret caCert = createSecret(
      "my-ca-cert",
      secretData,
      Map.of(caCertificateKey, KubernetesCredentials.CA_CERTIFICATE_KEY)
    );
    addCACertReference(caCert, multiSecret);
  }

  private void usernamePasswordSecret(Map<String, String> secretData, DataPlaneContract.MultiSecretReference.Builder multiSecret) {
  ...
  private void userCrtSecret(Map<String, String> secretData, DataPlaneContract.MultiSecretReference.Builder multiSecret) {
  ...
  private void saslMechanismSecret(Map<String, String> secretData, DataPlaneContract.MultiSecretReference.Builder multiSecret) {
